...
class Epic:
    ...
    def fetch_all(self, query_ids, start_chunk=None, end_chunk=None, overwrite=None, save_format=None):
        """
        ...
        return self.fetch(query_ids, chunk_sizes, start_chunk, end_chunk, overwrite, save_format)
...
def main(edw_user,
         ...
         start: ("start chunk", "option", "s") = None,
